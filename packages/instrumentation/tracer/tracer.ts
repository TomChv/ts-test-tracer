 ...
 *
 * This does not automatically initialize the telemetry.
 * Please call `initialize` before this function.
 */
...
/**
 * Tracer encapsulates the OpenTelemetry Tracer to provide
