...
export class BunTest {
  ...
  constructor(
    @argument({
      ...
      ignore: [
        "*",
        "!packages/bun-test",
        "packages/bun-test/node_modules",
        "packages/bun-test/dist",
        "!examples/bun",
  ...
  @func()
  async withBumpedVersion(version: string): Promise<BunTest> {
    this.source = this.devContainer()
    ...
    for (const exampleDir of exampleDirs) {
      exampleCtr = exampleCtr
        ...
        .withExec([
          ...
          "pkg",
          "set",
          `dependencies[@otel-test-runner/bun-test]=${version}`,
        ]);
    }
